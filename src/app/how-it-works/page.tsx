...
const STEPS = [
  ...
  },
  {
    ...
    description:
      "می‌توانید چند خدمت را هم‌زمان انتخاب کنید؛ سپس فقط متخصص‌هایی که همه‌ی آن خدمات را ارائه می‌دهند نمایش داده می‌شوند.",
  },
  {
    number: "۳",
...
export default function HowItWorksPage() {
  return (
    <div className="min-h-screen flex flex-col">
      <main className="flex-1 max-w-3xl mx-auto px-4 py-16 w-full space-y-12">
